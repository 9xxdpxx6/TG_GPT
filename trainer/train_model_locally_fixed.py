...
def setup_training_arguments(output_dir="../dataset/results"):
    ...
    return TrainingArguments(
        ...
        num_train_epochs=2,                    # Начинаем с 2 эпох
...
def save_model(trainer, tokenizer, output_dir="../dataset/my_dialogpt"):
...
def main():
    ...
    try:
        ...
        print("📁 Модель сохранена в папке '../dataset/my_dialogpt'")
